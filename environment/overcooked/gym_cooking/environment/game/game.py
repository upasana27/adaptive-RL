...
class Game:
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key in KeyToTuple_human1 and self.num_humans > 0:
                ...
                for i in range(self.num_humans):
                    self.env.unwrapped.world.agents[i].action = action
                    store_action_dict[self.env.unwrapped.world.agents[i]] = action
    ...
    def on_render(self, mode=''):
        return self.graphics_pipeline.on_render(mode)
