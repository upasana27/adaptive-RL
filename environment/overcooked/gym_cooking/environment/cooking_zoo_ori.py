...
def env(*, level, num_agents, record, max_steps, recipes, desire, obs_spaces,
...
class CookingEnvironment(AECEnv):
    ...
    def __init__(self, level, num_agents, record, max_steps, recipes, desire, obs_spaces=["numeric"],
